...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>┌─────────────────────────────────────────────────────────────────┐
│                    DATA LOADING                                  │
├─────────────────────────────────────────────────────────────────┤
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>Row 500,000 from dataset:
{
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>map<string, double> row_data;
row_data["fit101"] = 2.5;
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>Input row features:
  mv101 = 1.0     (categorical)
  fit101 = 2.5    (float)
  lit101 = 50.2   (float)</pre></div>

**Processing:** Each encoder converts to SDR (Sparse Distributed Representation)
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>// Create encoders (done once at startup)
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>sdr_mv101.getSparse() → {45, 127, 234, 567, 789, 1001, ..., 2103}  (80 indices)
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>L0_1_result = mergeSDRsUnion({sdr_mv101, sdr_fit101, sdr_lit101})
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>L0_1: SDR(size=2304, active=~240)  [mv101, fit101, lit101]
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>map<string, SDR> layer0_output = {
  {"L0_1", sdr_group_1},
  {"L0_2", sdr_group_2},
  {"L0_3", sdr_group_3},
  ...
...
**Input to L1_1:**
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>Layer 0 outputs:
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>SpatialPooler processes:
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>TemporalMemory processes:
...
**Output from L1_1:**
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>struct L1_1_Output {
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>anomaly_score = 1 - (predicted_overlap / active_columns)
              = 1 - (1 / 32)
              = 0.969</pre></div>
...
**Input to L2_1:**
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>Layer 1 outputs (active_columns, not cells):
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>SpatialPooler:
...
**Output from L2_1:**
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>struct L2_1_Output {
...
**Input to L3_1:**
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>Layer 2 outputs:
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>L3_1 anomaly score: 0.844</pre></div>
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>Anomaly score: 0.844
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>Grid search over 101 thresholds (0.01 to 1.0):
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>config/
├── data/
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>features:
  fit101:
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>data/
└── swat_dataset.parquet    ← Water treatment plant sensor readings
                               446K-946K rows, 41 features + label</pre></div>

### **5. `results/` - Output**

<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>results/
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>Best | F1=0.4478 precision=0.4592 recall=0.4370 accuracy=0.7877 threshold=0.9700
Avg  | F1=0.2541 precision=0.1588 recall=0.8567 accuracy=0.3324</pre></div>

## 🔄 **HOW DATA FLOWS THROUGH THE SYSTEM**

### **Step 1: Load Configuration**
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>loadDataConfig("config/data/config_swat.yaml")      // 41 features
...
### **Step 2: Load Data**
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>loadParquet("data/swat_dataset.parquet")  // Try Parquet first (Apache Arrow)
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>encoders["fit101"].encode(2.5) → SDR of 2304 bits (≈80 bits active)
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>L0_1: [mv101, fit101, lit101] → Union/Concat → Single SDR
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>SDR input (e.g., 2304 bits)
  ↓
...
### **Step 6: Evaluation**
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>For each of 101 candidate thresholds:
  for each row:
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>seed: 69                    # Random seed for reproducibility
...
### **Encoder Parameters**
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>encoders:
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>columnDimensions: 1664          # Number of output columns
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>cellsPerColumn: 16              # Mini-columns burst (increases capacity)
...
### **Build Process**
<div style="background-color: white; color: #222; padding: 12px; border: 1px solid #ccc; border-radius: 4px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto;">
<pre>mkdir build
cd build
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>For each row i:
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>Best F1=0.4478 at threshold=0.97    ← This threshold should be used for production
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>Input SDR: 2304 bits (sparse, ~80 bits active)
    ↓
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>Column 42:
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>Column 42's synapses:
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>Input: [bits 5, 18, 234, 567 are active, others are 0]
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>All columns:    [overlap: 2, 5, 8, 12, 15, 3, 18, 7, 25, ...]
                         ↓
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>If connected synapse matched input bit:
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>All synapses to inactive bits:
  permanence -= synPermInactiveDec  (slowly weaken)
  Example: 0.45 - 0.0000052 = 0.4499</pre></div>

**Key params:**
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>synPermActiveInc: [3.493e-3]      # Strong increase for matches (0.003493)
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>Timestep 1: Random permanences
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>if column hasn't been active recently:
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>Input: Active columns from SP (e.g., {12, 42, 156})
    ↓
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>From SP output: Active columns = {12, 156, 423}
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>Cell (Column 12, Cell 1):
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>Step 1: Check all segments of all cells
  For each cell:
    For each segment:
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>Segment that made prediction:
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>Cell that should have predicted but didn't:
...
**Key params:**
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>permanenceInc: [0.075, 0.075, 0.075, 0.175]      # Reward correct predictions
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>Sequence: [sensor_A, sensor_B, sensor_C, sensor_A, sensor_B, sensor_C, ...]
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>Normal sequence: [A, B, C, A, B, C, ...]
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>Size: 2304 bits
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>SDR 1 (feature: fit101=2.5):    {5, 18, 234, 567, ...}  (80 bits)
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>SDR 1 (2304 bits, 80 active):  [0,1,0,...,1,0]
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>feature_plan:
...
**What happens:**
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>// For L0_1:
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>Normal behavior:
...
In code:
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>float anomaly_score = 1.0 - (intersection_size / active_size);</pre></div>

**Example:**
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>predicted_columns (TM's guess): {42, 156, 423}       (3 columns)
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>Layer 1 output: active_cols={12, 42, 156}
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>Timestep 0-10000 (learning_period):
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>Layer 1: Detects local pattern anomalies
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre># Make TM more sensitive (predict less often = more "anomalies")
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre># Make TM pickier (predict more often = fewer "anomalies")
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>Best precision=0.4592 (46% correct predictions)
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre># Model doesn't need as much warm-up
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>models:
  sp:
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>Config                    | Best F1 | Precision | Recall | Avg F1
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre># Layer config is per-layer (4 values each)
sp:
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>Original data split:
...
<div style="background-color: white; color: black; padding: 12px; font-family: 'Courier New', monospace; font-size: 13px; overflow-x: auto; line-height: 1.4;"><pre>START: Check current metrics
│
├─ If F1 < 0.3
