...
├─────────────────────────────────────────────────────────────────┤
│                                                                 │
│  LAYER 0 (Encoders)     L0_1   L0_2   L0_3   ... (10 groups)  │
│          ↓      ↓       ↓                                       │
...
```bash
# Run current config, note F1 and precision/recall
docker-compose up --build
# Record: Best F1, Best Precision, Best Recall, Avg F1
```
